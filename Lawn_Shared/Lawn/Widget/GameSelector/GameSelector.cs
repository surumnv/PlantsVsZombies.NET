...
namespace Lawn
{
    public/*internal*/ class GameSelector : Widget, ButtonListener, StoreListener, AlmanacListener, MiniGamesWidgetListener, QuickPlayWidgetListener
    {
        public GameSelector(LawnApp theApp)
        {
            ...
            mInUserDialog = false;
            mAdventureButton = GameButton.MakeNewButton((int)GameSelectorButtons.Adventure, this, "", null, AtlasResources.IMAGE_REANIM_SELECTORSCREEN_ADVENTURE_BUTTON, AtlasResources.IMAGE_REANIM_SELECTORSCREEN_ADVENTURE_HIGHLIGHT, AtlasResources.IMAGE_REANIM_SELECTORSCREEN_ADVENTURE_HIGHLIGHT);
            ...
            mZenGardenButton = GameButton.MakeNewButton((int)GameSelectorButtons.ZenGarden, this, "", null, AtlasResources.IMAGE_REANIM_SELECTORSCREEN_ZENGARDEN, AtlasResources.IMAGE_REANIM_SELECTORSCREEN_ZENGARDEN_HIGHLIGHT, AtlasResources.IMAGE_REANIM_SELECTORSCREEN_ZENGARDEN_HIGHLIGHT);
            ...
            mOptionsButton = GameButton.MakeNewButton((int)GameSelectorButtons.Options, this, "", null, AtlasResources.IMAGE_SELECTORSCREEN_OPTIONS1, AtlasResources.IMAGE_SELECTORSCREEN_OPTIONS2, AtlasResources.IMAGE_SELECTORSCREEN_OPTIONS2);
            ...
            mStoreButton = GameButton.MakeNewButton((int)GameSelectorButtons.Store, this, "", null, AtlasResources.IMAGE_SELECTORSCREEN_STORE, AtlasResources.IMAGE_SELECTORSCREEN_STOREHIGHLIGHT, AtlasResources.IMAGE_SELECTORSCREEN_STOREHIGHLIGHT);
            ...
            mAlmanacButton = GameButton.MakeNewButton((int)GameSelectorButtons.Almanac, this, "", null, AtlasResources.IMAGE_SELECTORSCREEN_ALMANAC, AtlasResources.IMAGE_SELECTORSCREEN_ALMANACHIGHLIGHT, AtlasResources.IMAGE_SELECTORSCREEN_ALMANACHIGHLIGHT);
            ...
            mMoreGamesButton = GameButton.MakeNewButton((int)GameSelectorButtons.MoreGames, this, "", null, AtlasResources.IMAGE_REANIM_SELECTORSCREEN_MOREGAMES_BUTTON, AtlasResources.IMAGE_REANIM_SELECTORSCREEN_MOREGAMES_HIGHLIGHT, AtlasResources.IMAGE_REANIM_SELECTORSCREEN_MOREGAMES_HIGHLIGHT);
            ...
            mMoreGamesBackButton = GameButton.MakeNewButton((int)GameSelectorButtons.MoreGamesBack, this, "", null, AtlasResources.IMAGE_REANIM_SELECTORSCREEN_MOREGAMES_BACK_BUTTON, AtlasResources.IMAGE_REANIM_SELECTORSCREEN_MOREGAMES_BACK_HIGHLIGHT, AtlasResources.IMAGE_REANIM_SELECTORSCREEN_MOREGAMES_BACK_HIGHLIGHT);
