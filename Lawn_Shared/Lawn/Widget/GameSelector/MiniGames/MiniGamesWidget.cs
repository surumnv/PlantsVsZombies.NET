    ...
    public/*internal*/ class MiniGamesWidget : Widget
    {
        ...
        public override void Draw(Graphics g)
        {
            ...
            for (int j = 0; j < modeLevelCount; j++)
            {
                ...
                g.ClearClipRect();
                g.WriteWordWrapped(new TRect(num + 15, AtlasResources.IMAGE_MINI_GAME_FRAME.mHeight + Constants.Gameselector_LevelName_Offset, AtlasResources.IMAGE_MINI_GAME_FRAME.mWidth - 30, 100), levelName, 5, 0);
