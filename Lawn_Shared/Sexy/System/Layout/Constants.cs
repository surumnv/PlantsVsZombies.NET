...
namespace Sexy
{
    public /*internal*/ class Constants : FrameworkConstants
    {
        public static void Load320x480()
        {
            ...
            Constants.GameSelector_AdventureButton_Y = 10;
            ...
            Constants.Almanac_ZombieSpace = new Point(166, 166);
        ...
        public static void Load480x800()
        {
            ...
            Constants.S = 2.0f;
            Constants.IS = 0.5f;
            FrameworkConstants.Font_Scale = 2f;
            ...
            Constants.Loaded = true;
            Constants.BackBufferSize = new Point(1536, 2048);
            Constants.ImageSubPath = "\\480x800\\";
            Constants.BOARD_WIDTH = 2048;
            Constants.BOARD_HEIGHT = 1536;
            Constants.BOARD_EDGE = 50;
            Constants.BOARD_OFFSET = 35;
            Constants.BOARD_EXTRA_ROOM = 100;
            Constants.HIGH_GROUND_HEIGHT = 30;
            Constants.GRIDSIZEX = 9;
            Constants.MAX_GRIDSIZEY = 6;
            ...
            Constants.SMALL_SEEDPACKET_WIDTH = 130;//卡槽宽度
            Constants.SMALL_SEEDPACKET_HEIGHT = 180;//卡槽高度
            Constants.SEED_CHOOSER_OFFSETSCREEN_OFFSET = 1536;
            Constants.SCROLL_AREA_OFFSET_X = 128 * i;
            Constants.SCROLL_AREA_OFFSET_Y = (int)Constants.InvertAndScale(28f);
            Constants.DIALOG_HEADER_OFFSET = 45 * i;
            Constants.WIDE_BOARD_WIDTH = 900;
            Constants.ImageWidth = (int)(Constants.S * 1400f);
            Constants.LAWN_XMIN = 220;
            Constants.LAWN_YMIN = 180;
            ...
            Constants.GameSelector_MiniGameButton_X = 1020;//主界面更多游戏方式按钮
            Constants.GameSelector_MiniGameButton_Y = 572;//主界面更多游戏方式按钮
            Constants.GameSelector_OptionsButton_X = 828 * i;
            Constants.GameSelector_OptionsButton_Y = 345 * i;
            Constants.GameSelector_ZenGardenButton_X = 1354;//主界面花园按钮
            Constants.GameSelector_ZenGardenButton_Y = 1023;//主界面花园按钮
            Constants.GameSelector_AlmanacButton_X = 1137;//主界面图鉴按钮
            Constants.GameSelector_AlmanacButton_Y = 1140;//主界面图鉴按钮
            Constants.GameSelector_StoreButton_X = 1008;//主界面商店按钮
            Constants.GameSelector_StoreButton_Y = 947;//主界面商店按钮
            Constants.GameSelector_LeaderboardButton_X = 0;
            Constants.GameSelector_LeaderboardButton_Y = (int)Constants.InvertAndScale(200f);
            Constants.GameSelector_AchievementsButton_X = 264 * i ;
            ...
            Constants.GameSelector_LevelNumber_3_Pos = new Point(740 * i, 43 * i);
            Constants.GameSelector_LevelNumber_Bar = new Rectangle(716 * i, 55 * i, 6 * i, 3 * i);
            Constants.GameSelector_LevelNumber_ButtonDown_Offset = 8 * i;
            Constants.GameSelector_Update_Offset = 110;
            Constants.Gameselector_LevelName_Offset = -100;//关卡按钮上的名称
            Constants.LeaderboardScreen_Vasebreaker_Button_X = 791 * i;
            Constants.LeaderboardScreen_Vasebreaker_Button_Y = 424 * i;
            Constants.LeaderboardScreen_IZombie_Button_X = 156 * i;
            Constants.LeaderboardScreen_IZombie_Button_Y = 383 * i;
            Constants.LeaderboardScreen_Killed_Button_X = 506 * i;
            Constants.LeaderboardScreen_Killed_Button_Y = 383 * i;
            Constants.LeaderboardScreen_PileBase_X = 414 * i;
            Constants.LeaderboardScreen_PileBase_Y = 66 * i;
            Constants.Leaderboard_IZombie_Score_X = 248 * i;
            Constants.Leaderboard_IZombie_Score_Y = 363 * i;
            Constants.Leaderboard_Vasebreaker_Score_X = 873 * i;
            Constants.Leaderboard_Vasebreaker_Score_Y = 403 * i;
            Constants.Leaderboard_Pile_1_X = 371 * i;
            Constants.LeaderboardDialog_CannotConnect_Rect = new TRect(38 * i, 88 * i, 713 * i, 375 * i);
            Constants.LeaderboardScreen_EdgeOfSpace_Overlay_Offset = 38 * i;
            Constants.AchievementWidget_ROW_HEIGHT = 169 * i;
            Constants.AchievementWidget_ROW_START = 344 * i;
            Constants.AchievementWidget_HOLE_DEPTH = 160 * i;
            Constants.AchievementWidget_GAMERSCORE_POS = new Point(271 * i, 431 * i);
            Constants.AchievementWidget_BackButton_X = 190 * i;
            Constants.AchievementWidget_BackButton_Y = 8 * i;
            Constants.AchievementWidget_BackButton_Rect = new TRect(190 * i, 0 * i, 213 * i, 150 * i);
            Constants.AchievementWidget_Background_Offset_Y = 515 * i;
            Constants.AchievementWidget_Description_Box = new Rectangle(338 * i, 38 * i, 500 * i, 88 * i);
            Constants.AchievementWidget_Pipe_Offset = new Point(0, 175 * i);
            Constants.AchievementWidget_Worm_Offset = new Point(824 * i, -130 * i);
            Constants.AchievementWidget_ZombieWorm_Offset = new Point(95 * i, -11 * i);
            Constants.AchievementWidget_GemLeft_Offset = new Point(225 * i, 0);
            Constants.AchievementWidget_GemRight_Offset = new Point(563 * i, -86 * i);
            Constants.AchievementWidget_Fossile_Offset = new Point(299 * i, -69 * i);
            Constants.AchievementWidget_Image_Pos = new Point(250 * i, 13 * i);
            Constants.AchievementWidget_Image_Size = 80 * i;
            Constants.AchievementWidget_Name_Pos = new Point(338 * i, 0);
            Constants.AchievementWidget_Name_MaxWidth = 500 * i;
            Constants.QuickPlayWidget_Thumb_X = 25 * i;
            Constants.QuickPlayWidget_Thumb_Y = 19 * i;
            Constants.QuickPlayWidget_Bungee_Y = -65 * i;
            Constants.SeedChooserScreen_MenuButton_X = 831 * i;
            Constants.SeedChooserScreen_Background_Top = new Point(110 * i, 5 * i);
            Constants.SeedChooserScreen_Background_Middle = new Point(Constants.SeedChooserScreen_Background_Top.X, Constants.SeedChooserScreen_Background_Top.Y + 55 * i);
            Constants.SeedChooserScreen_Background_Middle_Height = 406 * i;
            ...
            Constants.SeedChooserScreen_Gradient_Top = new Rectangle(0, 50 * i, 420 * i, 28 * i);
            Constants.SeedChooserScreen_Gradient_Bottom = new Rectangle(0, 453 * i, 420 * i, 28 * i);
            Constants.SeedPacket_Cost = new Point(53 * i, 33 * i);
            Constants.SeedPacket_Cost_IZombie = new Point(51 * i, 34 * i);
            Constants.SeedPacket_CostText_Pos = new Point(93 * i, 28 * i);
            Constants.SeedPacket_CostText_IZombie_Pos = new Point(91 * i, 29 * i);
            Constants.ImitaterDialog_Size = new Point(0, 300 * i);
            Constants.ImitaterDialog_ScrollWidget_Offset_X = 6 * i;
            Constants.ImitaterDialog_ScrollWidget_Y = 150 * i;
            Constants.ImitaterDialog_ScrollWidget_ExtraWidth = 25 * i;
            Constants.ImitaterDialog_Height = 313 * i;
            Constants.ImitaterDialog_BottomGradient_Y = 294 * i;
            Constants.CutScene_ReadySetPlant_Pos = new Point(463 * i, 325 * i);
            Constants.CutScene_LogoEndPos = 438 * i;
            Constants.CutScene_LogoBackRect_Height = 150;
            Constants.CutScene_LogoEnd_Particle_Pos = new Point(750 * i, 500 * i);
            Constants.CutScene_ExtraRoom_1_Particle_Pos = new Point(35, 348);
            ...
            Constants.CutScene_Upsell_TerraCotta_Arrow = new Point(916 * i, 450 * i);
            Constants.CutScene_Upsell_TerraCotta_Pot = new Point(706 * i, 450 * i);
            Constants.ConveyorBeltClipRect = new TRect(0, 10 * i, 104 * i, 581 * i);
            Constants.StoreScreen_BackButton_X = 538 * i;
            Constants.StoreScreen_BackButton_Y = 488 * i;
            Constants.StoreScreen_Car_X = 325 * i;
            Constants.StoreScreen_Car_Y = 100 * i;
            Constants.StoreScreen_PrevButton_X = 396 * i;
            Constants.StoreScreen_PrevButton_Y = 370 * i;
            Constants.StoreScreen_NextButton_X = 806 * i;
            Constants.StoreScreen_NextButton_Y = 370 * i;
            Constants.StoreScreen_HatchOpen_X = 395 * i;
            Constants.StoreScreen_HatchOpen_Y = -44 * i;
            Constants.StoreScreen_HatchClosed_X = 386 * i;
            Constants.StoreScreen_HatchClosed_Y = 101 * i;
            Constants.StoreScreen_CarNight_X = 325 * i;
            Constants.StoreScreen_CarNight_Y = 100 * i;
            Constants.StoreScreen_StoreSign_X = 563 * i;
            Constants.StoreScreen_StoreSign_Y_Min = -188 * i;
            Constants.StoreScreen_StoreSign_Y_Max = -13 * i;
            Constants.StoreScreen_Coinbank_X = 738 * i;
            Constants.StoreScreen_Coinbank_Y = 506 * i;
            Constants.StoreScreen_Coinbank_TextOffset = new Point(225 * i, 10 * i);
            Constants.StoreScreen_ItemOffset_1_X = 538 * i;
            Constants.StoreScreen_ItemOffset_1_Y = 128 * i;
            Constants.StoreScreen_ItemOffset_2_X = 610 * i;
            Constants.StoreScreen_ItemOffset_2_Y = 238 * i;
            Constants.StoreScreen_ItemSize = 106 * i;
            Constants.StoreScreen_ItemSize_Offset = 5 * i;
            Constants.StoreScreen_PriceTag_X = 4 * i;
            Constants.StoreScreen_PriceTag_Y = 88 * i;
            Constants.StoreScreen_PriceTag_Text_Offset_X = 44 * i;
            Constants.StoreScreen_PriceTag_Text_Offset_Y = 84 * i;
            Constants.StoreScreen_ComingSoon_X = 125 * i;
            Constants.StoreScreen_ComingSoon_Y = 88 * i;
            Constants.StoreScreen_SoldOut_Width = 100 * i;
            Constants.StoreScreen_SoldOut_Y = 0;
            Constants.StoreScreen_SoldOut_Height = 125 * i;
            Constants.StoreScreen_PacketUpgrade_X = 13 * i;
            Constants.StoreScreen_PacketUpgrade_Y = 6 * i;
            Constants.StoreScreen_PacketUpgrade_Text_Size = new Rectangle(0, 0, 100 * i, 75 * i);
            Constants.StoreScreen_RetardedDave_Offset_X = -13 * i;
            Constants.StoreScreen_FirstAidNut_Offset_Y = 13 * i;
            Constants.StoreScreen_PoolCleaner_Offset_X = 29 * i;
            Constants.StoreScreen_PoolCleaner_Offset_Y = 30 * i;
            Constants.StoreScreen_Rake_Offset_X = -13 * i;
            Constants.StoreScreen_Rake_Offset_Y = 30 * i;
            Constants.StoreScreen_RoofCleaner_Offset_X = 19 * i;
            Constants.StoreScreen_RoofCleaner_Offset_Y = 48 * i;
            Constants.StoreScreen_Imitater_Offset_X = -1;
            Constants.StoreScreen_Imitater_Offset_Y = 30 * i;
            Constants.StoreScreen_Default_Offset_Y = 25 * i;
            Constants.StoreScreen_MouseRegion = new Point(94 * i, 125 * i);
            Constants.StoreScreen_Dialog = new Rectangle(250 * i, 63 * i, 500 * i, 563 * i);
            Constants.StoreScreen_PotPlant_Offset = new Point(50 * i, 88 * i);
            Constants.StoreScreenMushroomGardenOffsetX = 19 * i;
            Constants.StoreScreenAquariumGardenOffsetX = 19 * i;
            Constants.StoreScreenGloveOffsetY = 19 * i;
            Constants.StoreScreenWheelbarrowOffsetY = 19 * i;
            Constants.StoreScreenBugSprayOffsetX = 21 * i;
            Constants.StoreScreenBugSprayOffsetY = 19 * i;
            Constants.StoreScreenPhonographOffsetY = 19 * i;
            Constants.StoreScreenPlantFoodOffsetX = 16 * i;
            Constants.StoreScreenPlantFoodOffsetY = 19 * i;
            Constants.StoreScreenWateringCanOffsetX = 8 * i;
            Constants.StoreScreenWateringCanOffsetY = 19 * i;
            Constants.NewOptionsDialog_FXLabel_X = 425 * i;
            Constants.NewOptionsDialog_FXLabel_Y = 179 * i;
            Constants.NewOptionsDialog_MusicLabel_X = 425 * i;
            Constants.NewOptionsDialog_MusicLabel_On_Y = 121 * i;
            Constants.NewOptionsDialog_MusicLabel_Off_Y = 129 * i;
            Constants.NewOptionsDialog_VibrationLabel_X = 425 * i;
            Constants.NewOptionsDialog_VibrationLabel_Y = 241 * i;
            Constants.NewOptionsDialog_LockedLabel_Y = 331 * i;
            Constants.NewOptionsDialog_VibrationLabel_MaxWidth = 375 * i;
            Constants.NewOptionsDialog_FullScreenOffset = 31 * i;
            Constants.NewOptionsDialog_FX_Offset = 19 * i;
            Constants.NewOptionsDialog_Music_Offset = 6 * i;
            Constants.NewOptionsDialog_Version_Low_Y = 425 * i;
            Constants.NewOptionsDialog_Version_High_Y = 431 * i;
            Constants.RetardedDave_Bubble_Tip_Offset = 6 * i;
            Constants.RetardedDave_Bubble_Offset_Shop = new Point(-350 * i, -146 * i);
            Constants.RetardedDave_Bubble_Offset_Board = new Point(-250 * i, -75 * i);
            Constants.RetardedDave_Bubble_Size = 500 * i;
            Constants.RetardedDave_Bubble_Rect = new TRect(19 * i, 8 * i, 0, 313 * i);
            Constants.RetardedDave_Bubble_TapToContinue_Y = 288 * i;
            Constants.PlantGallerySize = new Point(1238, 1106);//植物图鉴的大小
            Constants.ZombieGallerySize = new Point(908, 1045);//僵尸图鉴的大小
            Constants.AlmanacHeaderY = 60;
            Constants.Almanac_PlantsButtonRect = new TRect(84 * i, 188 * i, 375 * i, 300 * i);
            Constants.Almanac_ZombiesButtonRect = new TRect(563 * i, 188 * i, 375 * i, 300 * i);
            Constants.Almanac_CloseButtonRect = new TRect(825 * i, 544 * i, 185 * i, 49 * i);
            Constants.Almanac_IndexButtonRect = new TRect(553 * i, 544 * i, 185 * i, 49 * i);
            Constants.Almanac_IndexPlantPos = new Point(229 * i, 300 * i);
            Constants.Almanac_IndexZombiePos = new Point(691 * i, 281 * i);
            Constants.Almanac_IndexPlantTextPos = new Point(Constants.Almanac_PlantsButtonRect.mX + Constants.Almanac_PlantsButtonRect.mWidth / 2, Constants.Almanac_PlantsButtonRect.mY + Constants.Almanac_PlantsButtonRect.mHeight - 81 * i);
            Constants.Almanac_IndexZombieTextPos = new Point(Constants.Almanac_ZombiesButtonRect.mX + Constants.Almanac_ZombiesButtonRect.mWidth / 2, Constants.Almanac_ZombiesButtonRect.mY + Constants.Almanac_ZombiesButtonRect.mHeight - 81 * i);
            Constants.Almanac_PlantScrollRect = new TRect(71, 258, 1238, 1106);//图鉴中植物滚动区域
            Constants.Almanac_ZombieScrollRect = new TRect(35 * i, 94 * i, 513 * i, 460 * i);
            Constants.Almanac_DescriptionScrollRect = new TRect(1347, 800, 585, 486);//图鉴介绍框的大小和位置，待调整
            Constants.Almanac_PlantTopGradientY = 93 * i;
            Constants.Almanac_ZombieTopGradientY = 90 * i;
            Constants.Almanac_BottomGradientY = 540 * i;
            Constants.Almanac_PlantGradientWidth = 450 * i ;
            Constants.Almanac_ZombieGradientWidth = 488 * i;
            Constants.Almanac_ZombieStoneRect = new TRect(556 * i, 3 * i, 441 * i, 581 * i);
            Constants.Almanac_BackgroundPosition = new Point(1360, 275);//图鉴中植物背景区域，待调整
            Constants.Almanac_ZombieClipRect = new TRect(-50 * i, -56 * i, 219 * i, 219 * i);
            Constants.Almanac_NavyRect = new TRect(644 * i, 50 * i, 245 * i, 248 * i);
            Constants.Almanac_NamePosition = new Point(1570, 715);//图鉴中植物名称，待调整
            Constants.Almanac_ClayRect = new TRect(1322, 257, 631, 1063);
            Constants.Almanac_BrownRect = new TRect(1340, 275, 596, 422);//图鉴右侧那个显示植物外观的框的大小
            Constants.Almanac_ZombieSpace = new Point(166, 166);
            Constants.Almanac_ZombieOffset = new Point(0, 6 * i);
            Constants.Almanac_BossPosition = new Point(256 * i, 1180 * i);
            Constants.Almanac_ImpPosition = new Point(85 * i, 1180 * i);
            Constants.Almanac_ImitatorPosition = new Point(Constants.PlantGallerySize.X / 2 - 65 * i, 860 * i);
            Constants.Almanac_SeedSpace = new Point(5 * i, 5 * i);
            Constants.Almanac_SeedOffset = new Point(20 * i, 10 * i);
            Constants.Almanac_ZombiePosition = new Point(700, 120);
            Constants.Almanac_PlantPosition = new Point(1600, 510);//图鉴中植物位置，待调整
            Constants.Almanac_Text_Scale = 0.8f;
            Constants.Almanac_PlantsHeader_Pos = new Point(316, 60);//图鉴植物页标题
            Constants.Almanac_ZombieHeader_Pos = new Point(316, 60); //图鉴僵尸页标题
            Constants.Almanac_ItemName_MaxWidth = 413 * i;
            Constants.Zombie_StartOffset = 110f;
            Constants.Zombie_StartRandom_Offset = 40f;
            Constants.AwardScreen_Note_Credits_Background = new Rectangle(-625 * i, -213 * i, 2000 * i, 1000 * i);
            Constants.AwardScreen_Note_Credits_Paper = new Point(173, 63);
            Constants.AwardScreen_Note_Credits_Text = new Rectangle(225, 100, 536, 359);
            Constants.AwardScreen_Note_Help_Background = new Rectangle(-438, -188, 2125, 875);
            Constants.AwardScreen_Note_Help_Paper = new Point(173, 63);
            Constants.AwardScreen_Note_Help_Text = new Point(225, 119);
            Constants.AwardScreen_Note_1_Background = new Rectangle(-375, -188, 2000, 875);
            Constants.AwardScreen_Note_1_Paper = new Point(173, 63);
            Constants.AwardScreen_Note_1_Text = new Point(225, 106);
            Constants.AwardScreen_Note_Message = new Point(500, 0);
            Constants.AwardScreen_Note_2_Background = new Rectangle(-375, -188, 2000, 875);
            Constants.AwardScreen_Note_2_Paper = new Point(173, 63);
            Constants.AwardScreen_Note_2_Text = new Point(219, 106);
            Constants.AwardScreen_Note_3_Background = new Rectangle(-375, -188, 2000, 875);
            Constants.AwardScreen_Note_3_Paper = new Point(173, 63);
            Constants.AwardScreen_Note_3_Text = new Point(206, 100);
            Constants.AwardScreen_Note_4_Background = new Rectangle(-375, -188, 2000, 875);
            Constants.AwardScreen_Note_4_Paper = new Point(173, 63);
            Constants.AwardScreen_Note_4_Text = new Point(200, 100);
            Constants.AwardScreen_Note_Final_Background = new Rectangle(-375, -188, 2000, 875);
            Constants.AwardScreen_Note_Final_Paper = new Point(173, 63);
            Constants.AwardScreen_Note_Final_Text = new Point(213, 119);
            Constants.AwardScreen_Bacon = (Constants.AwardScreen_Taco = (Constants.AwardScreen_CarKeys = new Point(239, 263)));
            Constants.AwardScreen_WateringCan = new Point(225, 263);
            Constants.AwardScreen_Almanac = new Point(244, 231);
            Constants.AwardScreen_Trophy = new Point((int)(400f * Constants.S), (int)(137f * Constants.S));
            Constants.AwardScreen_Shovel = new Point(244, 244);
            Constants.AwardScreen_MenuButton = new Point(763, 525);
            Constants.AwardScreen_ClayTablet = new TRect(63, 88, 875, 375);
            Constants.AwardScreen_TitlePos = new Point(500, 13);
            Constants.AwardScreen_GroundDay_Pos = new Point(139, 209);
            Constants.AwardScreen_BrownRect = new TRect(113, 181, 250, 250);
            Constants.AwardScreen_BottomMessage_Pos = new Point(500, 88);
            Constants.AwardScreen_BottomText_Rect_Text = new TRect(396, 200, 500, 213);
            Constants.AwardScreen_BottomText_Rect_NoText = new TRect(188, 150, 625, 250);
            Constants.AwardScreen_CreditsButton = new TRect(225, 516, 175, 60);
            Constants.AwardScreen_CreditsButton_Offset = new Point(63, -9);
            if (Constants.Language == Constants.LanguageIndex.es)
            {
                Constants.AwardScreen_CreditsButton_Offset.X = 88;
            }
            ...
            {
                Constants.AwardScreen_CreditsButton_Offset.X = 75;
            }
            Constants.AwardScreen_Seed_Pos = new Point(189, 275);
            Constants.AwardScreen_ContinueButton_Offset = 44;
            Constants.AwardScreen_AchievementImage_Pos = new Point(100, 5);
            Constants.AwardScreen_AchievementName_Pos = new Point(250, 6);
            Constants.AwardScreen_AchievementDescription_Rect = new Rectangle(250, 38, 500, 75);
            Constants.CreditScreen_ReplayButton = new Rectangle(125, 500, 250, 60);
            Constants.CreditScreen_ReplayButton_TextOffset = new Point(-6, -9);
            Constants.CreditScreen_MainMenu = new Rectangle(625, 500, 250, 63);
            Constants.CreditScreen_TextStart = 250;
            Constants.CreditScreen_TextEnd = 500;
            Constants.CreditScreen_TextClip = 463;
            Constants.CreditScreen_LeftText_X = 0;
            Constants.CreditScreen_RightText_X = 488;
            Constants.CreditScreen_LeftRight_Text_Width = 463;
            Constants.ConfirmPurchaseDialog_Background = new TRect(48, 125, 390, 313);
            Constants.ConfirmPurchaseDialog_Item_Pos = new Point(75, 194);
            Constants.ConfirmPurchaseDialog_Text = new TRect(181, 119, 238, 331);
            Constants.LawnDialog_Insets = new Insets(75, 25, 88, 44);
            Constants.UILevelPosition = new Point(1360, 1430);//关卡信息的位置
            Constants.UIMenuButtonPosition = new Point(1800 - Constants.Board_Offset_AspectRatio_Correction, 4);//菜单键位置
            Constants.UIMenuButtonWidth = 230;
            Constants.UISunBankPositionX = 6;
            Constants.UISunBankTextOffset = new Point(97, 232);
            Constants.UIShovelButtonPosition = new Point(1425, 1);
            Constants.UIProgressMeterPosition = new Point(1439, 1452);//进度条位置
            Constants.UIProgressMeterHeadEnd = 576;//275
            Constants.UIProgressMeterBarEnd = 576;//275
            Constants.UICoinBankPosition = new Point(138 - Constants.Board_Offset_AspectRatio_Correction, 599);
            Constants.Board_Cutscene_ExtraScroll = -110;
            Constants.Board_SunCoinRange = 550;
            ...
            Constants.ZombieGalleryWidget_Window_Offset = new Point(4, 9); // Changed
            Constants.ZombieGalleryWidget_Window_Clip = new Rectangle(8, 5, 125, 125); // Changed
            ...
            Constants.ZEN_XMIN = 144;
            Constants.ZEN_YMIN = 493;
            Constants.ZEN_XMAX = 1900;
            Constants.ZEN_YMAX = 1200;
        ...
        /// 主界面上的冒险模式按钮
        /// </summary>
        public static int GameSelector_AdventureButton_Y;
        /// <summary>
        /// 主界面上的更多游戏方式按钮
        /// </summary>
        ...
        public static int Gameselector_LevelName_Offset;
